namespace JBoyer.Testing
{
    ...
    public class UTRandom : Random
    {
        ...
        public override int Next(int maxValue)
        {
            ...
            {
                throw new ArgumentException("List of numbers do not have value less than the max value.", nameof(maxValue));
            }
        ...
        public override int Next(int minValue, int maxValue)
        {
            ...
            {
                throw new ArgumentException("List of numbers do not have a valid value with passed parameters.");
            }
